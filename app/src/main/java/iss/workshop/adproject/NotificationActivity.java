...
public class NotificationActivity extends AppCompatActivity {
    private static final String URL = "http://10.0.2.2:8080/api/cameras/most-preferred/camera-id/4";
    ...
    private void sendGet() {
        ...
        client.newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onFailure(okhttp3.Call call, IOException e) {
                ...
                runOnUiThread(() -> Toast.makeText(NotificationActivity.this, "Request Failed: " + e.getMessage(), Toast.LENGTH_LONG).show());
            }
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setPriority(NotificationCompat.PRIORITY_DEFAULT); // 点击后自动取消通知
